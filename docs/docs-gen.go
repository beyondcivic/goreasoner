...
func GenerateTypeSchemas() error {
	...
	reflector, err := GenerateReflector(
		"github.com/beyondcivic/goreasoner/pkg/reasoner", "../pkg/reasoner",
	)
	if err != nil {
		return err
	}
	...
	schema := reflector.Reflect(&reasoner.Reasoner{})
...
func GoMarkDoc() error {
	...
	repo := lang.Repo{
		Remote:        "https://github.com:beyondcivic/goreasoner",
		DefaultBranch: "main",
		PathFromRoot:  "",
	}
